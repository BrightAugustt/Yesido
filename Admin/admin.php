  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">View all wedding services created for customers</p>
        <a href="view_weddings.php" class="btn btn-primary">Weddings</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <a href="view_weddings.php" class="btn btn-primary">Shoots</a>
      </div>
    </div>
  </div>
