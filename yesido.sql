...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2022 at 11:19 AM
...
CREATE TABLE `wedding` (
  ...
  `wedding_price` double NOT NULL,
  `wedding_label` text CHARACTER SET latin1 NOT NULL,
  `wedding_img` varchar(100) CHARACTER SET latin1 NOT NULL,
  `wedding_key` varchar(100) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `shoots`
  MODIFY `shoot_id` int(11) NOT NULL AUTO_INCREMENT;
